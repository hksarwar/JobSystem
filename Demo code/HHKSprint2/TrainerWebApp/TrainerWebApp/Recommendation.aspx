<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Recommendation.aspx.cs" Inherits="TrainerWebApp.Recommendation" %>
...
<h2>
    ...
    <p>
     ...
     <p>
        <asp:GridView ID="gvRecJobs" runat="server"
                    autogenerateselectbutton="True"
                    selectedindex="-1" 
                    onselectedindexchanged="gvRecJobs_SelectedIndexChanged" 
    ...
    <asp:Panel ID="pnlSelectJob" runat="server" Visible="false" BackColor="AliceBlue">
        <asp:LinkButton ID="HideBTN" runat="server" onclick="HideBTN_Click">Hide</asp:LinkButton>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
        <br />
        Stream:

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeBehind="MyFavourites.aspx.cs" Inherits="ConsultantJobPortal.MyFavourites" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
     ...
     <p>
        <asp:GridView ID="gvFavJobs" runat="server"
                    ...
                    AllowSorting="true" 
                    AllowPaging="true" PageSize="5" onsorting="gvFavJobs_Sorting"
                     OnPageIndexChanging="gvFavJobs_PageIndexChanging">
    ...
    <asp:Panel ID="pnlSelectJob" runat="server" Visible="false" BackColor="AliceBlue">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:LinkButton ID="LbtnDelFavs" runat="server" onclick="LbtnDelFavs_Click" OnClientClick="javascript:return confirm('Are you sure you want to permanently delete this favourite? This action cannot be reversed.')" >Delete From Favourites</asp:LinkButton>
        <br />
        <br />
        Stream:
